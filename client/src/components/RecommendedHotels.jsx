...
const RecommendedHotels = () => {
  ...
  return rooms.length > 0 && (
    <div className='flex flex-wrap items-center justify-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
        ...
        <Title title='Recommended Hotels' subTitle='Discover our handpicked selection of
        expectational properties around the world, offering unparalleled luxury and unforgettable experiences.' />
