...
const Hero = () => {
  ...
  return (
    ...
    bg-no-repeat bg-cover bg-center h-screen w-full'>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at world's most exclusive hotels and resorts.
         ...
         flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                ...
                <input id="checkIn" type="date" className=" rounded border border-gray-200
            ...
            <div>
                ...
                <input id="checkOut" type="date" className=" rounded border
            ...
            <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
                ...
                mt-1.5 text-sm outline-none  max-w-16" placeholder="0" />
            </div>

            <button className='flex items-center justify-center gap-1 rounded-md bg-black 
            py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
