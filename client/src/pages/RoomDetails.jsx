...
const RoomDetails = () => {
    const{id} = useParams()
    const {navigate, getToken, axios, rooms} = useAppContext()        
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            <h1 className='text-3xl md:test-4xl font-playfair'>{room.hotel.name}
                 <span className='font-inter text-sm'>({room.roomType})</span></h1>
            <p className='font-inter text-sm py-1.5 px-3 text-white bg-orange-500 rounded-full'>20% OFF</p>
        </div>
        ...
        bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6px'>
        ...
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                <img src="https://img.freepik.com/vetores-gratis/luxo-letra-r-nome-dourado-inicial-conceito-de-design-de-logotipo-moderno-para-uma-marca-ou-empresa_626654-155.jpg?w=1060" alt="Host" 
